                        ...
                        <div class="events-item bg-primary rounded">
                            <div class="events-inner position-relative">
                                <div class="events-img overflow-hidden rounded-circle position-relative">
                                    <img src="../../public/img/event-1.jpg" class="img-fluid w-100 rounded-circle" alt="Image">
                                    <div class="event-overlay">
                                        <a href="../../public/img/event-1.jpg" data-lightbox="event-1"><i class="fas fa-search-plus text-white fa-2x"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between px-4 py-2 bg-secondary">
                                    ...
                                    <small class="text-white"><i class="fas fa-map-marker-alt me-1 text-primary"></i>Agadir</small>
                                </div>
                            </div>
